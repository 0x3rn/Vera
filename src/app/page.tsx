      ...
      <nav className="fixed top-0 w-full z-50 bg-[#070709]/80 backdrop-blur-xl border-b border-[#22222a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 h-[70px] flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#features" className="text-sm font-medium text-zinc-400 hover:text-white transition-colors duration-500 ease-out">Features</a>
            <a href="#how-it-works" className="text-sm font-medium text-zinc-400 hover:text-white transition-colors duration-500 ease-out">How It Works</a>
            <a href="#pricing" className="text-sm font-medium text-zinc-400 hover:text-white transition-colors duration-500 ease-out">Pricing</a>
            <a href="#faq" className="text-sm font-medium text-zinc-400 hover:text-white transition-colors duration-500 ease-out">FAQ</a>
          </div>
          <div className="flex items-center gap-6">
            {user ? (
              <div className="flex items-center gap-3">
                <Link href="/dashboard" className="text-sm font-medium text-zinc-400 hover:text-white transition-colors duration-500 ease-out">Dashboard</Link>
                <button onClick={signOut} className="text-sm font-medium text-zinc-500 hover:text-zinc-300 transition-colors duration-500 ease-out">Sign out</button>
              </div>
            ) : (
              <Link href="/login" className="text-sm font-medium text-zinc-400 hover:text-white transition-colors duration-500 ease-out">Sign in</Link>
            )}
          </div>
        </div>
      </nav>
      ...
      <main className="flex-grow pt-[70px]">
        ...
        <section className={isInput ? "pt-20 sm:pt-32 pb-16 relative" : "pt-8 sm:pt-16 pb-32 relative"} id="hero">
          <div className="max-w-7xl mx-auto px-4 sm:px-8">
            ...
            {isInput && (
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-16 text-center max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className={isInput ? "grid lg:grid-cols-2 gap-12 lg:gap-16 items-start" : "block"}>
              ...
              {isInput && (
                <div className="order-2 lg:order-1 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100 fill-mode-both">
              ...
              <div className={isInput ? "order-1 lg:order-2 w-full relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200 fill-mode-both" : "w-full"}>
        ...
        {scannerState === "idle" && (
          <>
            {/* 3. Trust Bar */}
            <section className="py-12 border-t border-b border-[#22222a] bg-[#070709]">
              <div className="max-w-7xl mx-auto px-4 sm:px-8 text-center opacity-70">
                ...
                <div className="flex flex-wrap justify-center gap-8 md:gap-16 text-zinc-400 font-semibold text-lg">
                  <span>Designers</span>
            ...
            <section className="py-24 relative overflow-hidden">
              <div className="max-w-7xl mx-auto px-4 sm:px-8">
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                  <div className="relative h-[400px] bg-[#1a1a24] border border-white/20 rounded-2xl flex flex-col overflow-hidden">
                  ...
                  <div className="space-y-6">
                    <div className="bg-[#121216] border border-red-500/30 p-6 rounded-2xl relative z-20 backdrop-blur-xl hover:-translate-y-1 transition-transform duration-500 ease-out">
                      <div className="flex items-start gap-4">
                        <div className="w-8 h-8 rounded-full bg-red-500/10 flex items-center justify-center flex-shrink-0 mt-1">
                          <span className="text-red-400 font-bold">⚠</span>
                        </div>
                        <div>
                          <h4 className="text-white font-bold text-lg mb-1">Payment Terms</h4>
                          <p className="text-zinc-400 text-sm leading-relaxed mb-3">Net-90 payment schedule detected. You may wait up to 90 days before receiving payment.</p>
                    ...
                    <div className="bg-[#121216] border border-amber-500/30 p-6 rounded-2xl relative z-20 backdrop-blur-xl hover:-translate-y-1 transition-transform duration-500 ease-out">
                      <div className="flex items-start gap-4">
                        <div className="w-8 h-8 rounded-full bg-amber-500/10 flex items-center justify-center flex-shrink-0 mt-1">
                          <span className="text-amber-400 font-bold">⚠</span>
                        </div>
                        <div>
                          <h4 className="text-white font-bold text-lg mb-1">Intellectual Property</h4>
                          <p className="text-zinc-400 text-sm leading-relaxed mb-3">Client receives perpetual rights to all deliverables before payment is completed.</p>
            ...
            {/* 5. Problem Section */}
            <section className="py-24 bg-[#0a0a0e] border-y border-[#22222a]">
              <div className="max-w-4xl mx-auto px-4 sm:px-8 text-center">
                ...
                <div className="grid sm:grid-cols-2 gap-4 text-left max-w-3xl mx-auto mb-10">
                  {["Net-90 payment terms", "Perpetual ownership transfers", "Exclusivity restrictions", "No cancellation compensation", "Automatic renewals"].map((trap, idx) => (
                    <div key={idx} className="flex items-center gap-3 bg-[#121216] p-4 rounded-xl border border-white/5">
                      ...
                      <span className="text-zinc-300 font-medium">{trap}</span>
                    </div>
                  ))}
                </div>
                <p className="text-xl font-bold text-white">By the time you discover the problem, you've already signed.</p>
              </div>
            </section>
            ...
            <section id="features" className="py-24">
              <div className="max-w-7xl mx-auto px-4 sm:px-8">
                <div className="text-center mb-16">
                  ...
                  <p className="text-lg text-zinc-400 max-w-2xl mx-auto">Vera's AI engine is strictly trained on legal contracts to catch what you missed.</p>
                </div>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {[
                    ...
                    <div key={idx} className="bg-white/5 backdrop-blur-sm border border-white/10 p-8 rounded-2xl hover:bg-white/10 hover:-translate-y-1 transition-all duration-500 ease-out">
            ...
            {/* 7. How It Works */}
            <section id="how-it-works" className="py-24 bg-[#0a0a0e] border-y border-[#22222a]">
                ...
                <div className="grid md:grid-cols-3 gap-12 relative">
                  ...
                  {[
                    ...
                    <div key={i} className="relative z-10 flex flex-col items-center">
                      <div className="w-16 h-16 rounded-2xl bg-[#121216] border border-indigo-500/30 text-indigo-400 flex items-center justify-center text-2xl font-bold mb-6">
                        {s.step}
                      </div>
            ...
            <section className="py-24">
              <div className="max-w-4xl mx-auto px-4 sm:px-8">
                <div className="text-center mb-16">
                  ...
                  <p className="text-lg text-zinc-400">Clear, actionable advice to help you negotiate better terms.</p>
                </div>
                <div className="space-y-6">
                  <div className="bg-[#121216] border border-white/5 p-6 rounded-2xl">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="text-white font-medium mb-2">Payment delayed for up to 90 days.</p>
                  ...
                  <div className="bg-[#121216] border border-white/5 p-6 rounded-2xl">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="text-white font-medium mb-2">Client retains perpetual IP rights.</p>
                        <div className="bg-emerald-500/10 border border-emerald-500/20 p-3 rounded-lg">
            ...
            <section className="py-24 bg-[#0a0a0e] border-y border-[#22222a]">
              <div className="max-w-4xl mx-auto px-4 sm:px-8">
                ...
                <div className="border border-white/10 rounded-2xl overflow-hidden">
                  <div className="grid grid-cols-2 bg-[#121216] border-b border-white/10 p-6">
                    <div className="font-bold text-lg text-zinc-400">Generic AI</div>
                    <div className="font-bold text-lg text-indigo-400 flex items-center gap-2">Vera <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg></div>
                  </div>
                  {[
                    ...
                    <div key={idx} className="grid grid-cols-2 p-6 border-b border-white/5 last:border-0 bg-white/[0.02]">
                      <div className="text-zinc-500 font-medium flex items-center gap-3">
                      ...
                      <div className="text-zinc-200 font-medium flex items-center gap-3">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                  {[
                    ...
                    <div key={idx} className="flex flex-col items-center">
                      <div className="w-16 h-16 rounded-full bg-white/5 border border-white/10 flex items-center justify-center mb-4 text-zinc-400">
                      ...
                      <p className="text-zinc-300 font-medium text-sm">{sec.text}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            {/* 11. Pricing Section */}
            <section id="pricing" className="py-24 bg-[#0a0a0e] border-y border-[#22222a]">
              <div className="max-w-4xl mx-auto px-4 sm:px-8">
                <div className="text-center mb-16">
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="bg-[#121216] border border-[#22222a] rounded-3xl p-8 text-center hover:border-zinc-600 transition-all duration-500 ease-out">
                    <p className="text-sm font-semibold text-zinc-500 uppercase tracking-wider mb-4">Per Scan</p>
                    <div className="text-5xl font-bold mb-4">$5</div>
                    <p className="text-zinc-400 text-sm mb-8">One contract, one fee</p>
                    <ul className="text-left space-y-4 mb-8">
                      <li className="flex items-center gap-3 text-sm text-zinc-300"><svg className="w-5 h-5 text-indigo-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>1 Full PDF Scan (up to 30 pages)</li>
                      <li className="flex items-center gap-3 text-sm text-zinc-300"><svg className="w-5 h-5 text-indigo-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>1-Page Plain English Summary</li>
                      <li className="flex items-center gap-3 text-sm text-zinc-300"><svg className="w-5 h-5 text-indigo-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>Highlights Red Flags & Toxic Clauses</li>
                      <li className="flex items-center gap-3 text-sm text-zinc-300"><svg className="w-5 h-5 text-indigo-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>Secure Checkout</li>
                    </ul>
                    <Link href="/login" className="inline-block w-full py-3.5 rounded-xl border border-white/10 text-sm font-bold hover:border-white/30 hover:bg-white/5 transition-all duration-500 ease-out">Get started</Link>
                  </div>
                  <div className="bg-[#121216] border border-indigo-500/50 rounded-3xl p-8 text-center hover:border-indigo-500 transition-all duration-500 ease-out relative">
                    <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-indigo-600 px-4 py-1 rounded-full text-xs font-bold uppercase tracking-wider flex items-center gap-1.5">
                    ...
                    <p className="text-sm font-semibold text-zinc-500 uppercase tracking-wider mb-4 mt-2">Pro</p>
                    <div className="text-5xl font-bold mb-2">$10<span className="text-lg font-normal text-zinc-600">/mo</span></div>
                    <p className="text-zinc-400 text-sm mb-8">Unlimited scans</p>
                    <ul className="text-left space-y-4 mb-8">
                      <li className="flex items-center gap-3 text-sm text-zinc-300"><svg className="w-5 h-5 text-indigo-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>Unlimited Document Scans</li>
                      <li className="flex items-center gap-3 text-sm text-zinc-300"><svg className="w-5 h-5 text-indigo-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>Export Summaries to PDF</li>
                      <li className="flex items-center gap-3 text-sm text-zinc-300"><svg className="w-5 h-5 text-indigo-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>Upload Multi-Document Portfolios</li>
                      <li className="flex items-center gap-3 text-sm text-zinc-300"><svg className="w-5 h-5 text-indigo-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>Priority Email Support</li>
                    </ul>
                    <a href="#hero" className="inline-block w-full py-3.5 rounded-xl bg-indigo-600 text-white text-sm font-bold hover:bg-indigo-700 hover:-translate-y-0.5 transition-all duration-500 ease-out">Get started free</a>
                  </div>
                </div>
              </div>
            </section>
              ...
              <div className="max-w-3xl mx-auto px-4 sm:px-8">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <details key={idx} className="group bg-[#121216] border border-[#22222a] rounded-xl overflow-hidden [&_summary::-webkit-details-marker]:hidden">
                      <summary className="flex items-center justify-between p-6 cursor-pointer font-semibold text-lg text-white hover:bg-white/[0.02] transition-colors duration-500 ease-out">
                        {faq.q}
                        <span className="ml-4 flex-shrink-0 text-zinc-500 group-open:rotate-180 transition-transform duration-500 ease-out">
