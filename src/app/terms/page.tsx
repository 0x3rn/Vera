            ...
            <section className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="bg-card border border-red-500/50 p-6 sm:p-8 rounded-2xl my-8 shadow-lg">
                  ...
                  <p className="text-foreground leading-relaxed mt-4 font-bold">
                    ANY "LAWYER REVIEW" RECOMMENDATION GENERATED BY THE SERVICE IS AN AUTOMATED PROGRAMMATIC OUTPUT BASED ON ALGORITHMIC SCORING. IT DOES NOT CONSTITUTE A FORMAL LEGAL OPINION. A RECOMMENDATION THAT A LAWYER IS "NOT NECESSARY" SHOULD NOT BE INTERPRETED AS A GUARANTEE OF LEGAL SAFETY.
                  </p>
                </div>
              </div>
            </section>
